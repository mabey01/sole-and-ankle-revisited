...
html {
  ...
  */
  ...
  --primary-hue: 340deg;
  --primary-color: hsl(var(--primary-hue) 65% 47%);

  --secondary-hue: 240deg;
  --secondary-color: hsl(var(--secondary-hue) 60% 63%);
  ...
  --modal-backdrop-color: hsl(var(--secondary-hue) 30% 10% / 0.7);
}
